...
pub fn normalized_duration(months: i64, days: i64, seconds: i64, nanos: i32) -> i128 {
...
mod tests {
    ...
    use crate::cypher::{ResultEdge, ResultNode, ResultValue, value::total_compare};
    ...
    #[test]
    fn mixed_numeric_boundaries_and_nonfinite_values_are_exact() -> crate::Result<()> {
        let values = [
            f64::NEG_INFINITY,
    ...
    #[test]
    fn variable_bytes_are_prefix_safe_and_preserve_nul_and_ff() -> crate::Result<()> {
        let values = [
            Vec::new(),
            vec![0],
            vec![0, 0],
    ...
    #[test]
    fn string_and_bytes_have_an_explicit_transitive_suborder() -> crate::Result<()> {
    ...
    #[test]
    fn date_key_length_covers_the_full_i64_payload() -> crate::Result<()> {
    ...
    #[test]
    fn recursive_length_semantics_and_maximum_are_exact() -> crate::Result<()> {
